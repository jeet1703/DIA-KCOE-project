...
const DataEntryForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${BASE_URL}/api/form/drdoone/records`, {
        method: "POST",
      ...
      <main className="p-8 max-w-3xl mx-auto flex-grow">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            type="text"
            name="piName"
            placeholder="Academia/Institute PI Name"
          ...
          <input
            type="text"
            name="coordinatingScientist"
            placeholder="Coordinating Lab Scientist"
            value={formData.coordinatingScientist}
            onChange={handleChange}
            className="border p-2 w-full"
          />
          <input
            ...
            placeholder="Research Vertical"
            value={formData.researchVertical}
            onChange={handleChange}
            className="border p-2 w-full"
          />
          <input
          ...
          <input
            type="text"
            name="durationAndPDC"
            placeholder="Duration & PDC"
            value={formData.durationAndPDC}
            onChange={handleChange}
            className="border p-2 w-full"
          />
          <input
